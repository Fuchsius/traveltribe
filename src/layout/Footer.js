            ...
            <div className="col-lg-6">
              ...
              <div className="single-cta-item pl-lg-60 mb-40">
                ...
                <div className="content">
                  ...
                  <a href="/tour" className="icon-btn">
                    <i className="far fa-long-arrow-right" />
                  </a>
                </div>
              </div>
            ...
            <div className="col-lg-12">
              ...
              <div className="footer-text">
                <p style={{textAlign: "center"}}>
                  Copy@ 2025 <span style={{ color: "#F7921E" }}>TravelTribe</span>,
                  All Right Reserved | Developed By <a target="_blank" href="https://fuchsius.com" style={{ color: "#F201F2" }}>Fuchsius</a>
                </p>
              </div>
            </div>
          </div>
